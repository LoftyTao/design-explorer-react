...
export default function App() {
  ...
  const { data, columns, numericCols, ranges } = activeDataset || { data: [], columns: { in: [], out: [], img: [] }, numericCols: [], ranges: {} };
              ...
              {viewSource === 'uploaded' && data.length === 0 ? (
                ...
                <>
                  ...
                  {columns.img.length > 0 && (
                    <div className="bg-white rounded-lg border border-zinc-200 shadow-sm mx-6 mt-6 overflow-hidden flex flex-col h-[500px] sm:h-[600px] lg:h-[800px] shrink-0 mb-6">
